...
const Guide = () => {
    ...
    const [city, setCity] = useState('Maroc');
    ...
    const submit = async (e) => {
        ...
        try {
            const response = await axios.post(API_URL + 'api/add-guide', formData);
    ...
    const deleteGuide = (id) => {
        axios.delete(API_URL + 'api/delete-guide/' + id)
            .then(() => {
                setGuides(guides.filter(f => f.id !== id))
            });
    }
    const searchData = (e) => {
        e.preventDefault();

        axios.post(API_URL + "api/search-guide/1", { search, searchValue })
            .then(response => {
                console.log(response.data)
                setGuides(response.data.guides)
                setDataLenght(response.data.guidesLenght)
            })
    ...
    return (
        <section className="mx-auto  py-4 mt-2 w-100 px-5" >
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h4 className="fw-semibold">Liste des guides touristiques</h4>
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Ajout Guide</h1>
