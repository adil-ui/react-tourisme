			...
			<section className="container">
				<div className="row mt-5">
					<div className="col-md-6 col-lg-3 mb-4 mb-md-0 ">
						<Link to="/" ><img src="/assets/logo1.png" alt="logo" width="200px" /></Link>
						<p className="mt-4 pe-3">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
						<div>
					...
					<div className="col-md-6 col-lg-3 mb-4 mb-md-0">
						...
						<div className="my-4">
							...
							<p className="fontSize17"><i class="bi bi-envelope-fill text-red align-middle fontSize17 me-1"></i><span className="text">visitemaroc@gmail.com</span></p>
				...
				<div className="row mt-5">
					<div className="col-md-12 text-center">
						<p classNameName="mt-4">Copyright &copy; 2023 VISITEMAROC. All rights reserved Designd By <Link to='https://adil-ui.github.io/Portfolio/' target='_blank'  className="text-red fw-semibold ">KingAdil</Link> </p>
					</div>
				</div>
			</section>
		</footer>
