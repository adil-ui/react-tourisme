            ...
            <div className="card border-0">
                ...
                <div className="pt-3 px-2">
                    ...
                    <div className='d-flex justify-content-between align-items-center mt-4'>
                        <p className='text-secondary fontSize17'><i class="bi bi-geo-alt-fill"></i> {elt.ville}</p>
                        {elt.price && <p className="fw-semibold text-danger fontSize19" >{elt.price} Dh/nuit</p>}
